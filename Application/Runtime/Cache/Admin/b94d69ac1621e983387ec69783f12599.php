...
<div class="row">
        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <form id="newpostform" class="form-horizontal adminex-form registerform" method="post" action="/admin.php/Ajax/addNewPost">
                 	<div class="form-group">
                        <label class="col-sm-2 col-sm-2 control-label">标题</label>
                        <div class="col-sm-10">
                            <input class="form-control" value="<?php echo ($data['title']); ?>"  nullmsg="请输入id！" datatype="n1-8" errormsg="id为1-8个数字" type="text" name="title" placeholder="输入文章标题">
                        </div>
                    </div>
                    <input type="hidden" name="id" value="<?php echo ($data['id']); ?>" />
                     <div class="form-group">
                        <label class="col-sm-2 control-label col-lg-2" for="inputSuccess">选择分类</label>
                        <div class="col-sm-10" id="categoryContainer">
                           	<?php if(is_array($category)): foreach($category as $key=>$vo): ?><a class="btn btn-default" style="margin-right:10px" type="button"><?php echo ($vo['name']); ?></a><?php endforeach; endif; ?>
                           	<input style="display:block;margin-top:10px;" type="text" class="form-control" value="<?php echo ($data['category']); ?>"  nullmsg="请输入id！" datatype="n1-8" errormsg="id为1-8个数字" type="text" name="category" placeholder="输入新分类">
                        </div>
                    </div>
                     <div class="form-group">
                        <label class="col-sm-2 control-label col-lg-2" for="inputSuccess">选择标签</label>
                        <div class="col-sm-10" id="tagContainer">
                           	<?php if(is_array($tag)): foreach($tag as $key=>$vo): ?><a class="btn btn-default" style="margin-right:10px" type="button"><?php echo ($vo['name']); ?></a><?php endforeach; endif; ?>
                           	<input style="display:block;margin-top:10px;" type="text" class="form-control" value="<?php echo ($data['tag']); ?>"  nullmsg="请输入id！" datatype="n1-8" errormsg="id为1-8个数字"  name="tag" placeholder="输入新标签">
                        </div>
                    </div>
					<div class="form-group">
                        <label class="col-sm-2 col-sm-2 control-label">summary</label>
                        <div class="col-sm-10">
                            <textarea name="summary" class="form-control"><?php echo ($data['summary']); ?></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="col-lg-offset-2 col-lg-10">
                    			<button id="fabiao" type="submit" class="btn btn-primary">发表</button>
                        </div>
                    </div>    		
                </form>
            </div>
