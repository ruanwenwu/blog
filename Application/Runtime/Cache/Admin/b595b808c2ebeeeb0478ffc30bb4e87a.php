            ...
            <div class="panel-body">
                <form id="newpostform" class="form-horizontal adminex-form registerform" method="post" action="/admin.php/Ajax/addNewPost">
                 	<div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" value="<?php echo ($hospitalInfo['id']); ?>"  nullmsg="请输入id！" datatype="n1-8" errormsg="id为1-8个数字" type="text" name="title" placeholder="输入文章标题">
                        </div>
                    </div>
                     <div class="form-group">
                        ...
                        <div class="col-sm-10" id="categoryContainer">
                           	...
                           	<input style="display:block;margin-top:10px;" type="text" class="form-control" value=""  nullmsg="请输入id！" datatype="n1-8" errormsg="id为1-8个数字" type="text" name="category" placeholder="输入新分类">
                        </div>
                    </div>
                     <div class="form-group">
                        ...
                        <div class="col-sm-10" id="tagContainer">
                           	...
                           	<input style="display:block;margin-top:10px;" type="text" class="form-control" value="<?php echo ($hospitalInfo['id']); ?>"  nullmsg="请输入id！" datatype="n1-8" errormsg="id为1-8个数字"  name="tag" placeholder="输入新标签">
                        </div>
                    </div>
					<div class="form-group">
