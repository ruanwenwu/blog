    ...
    <div class="left-side sticky-left-side">
        ...
        <div class="left-side-inner">
            ...
            <ul class="nav nav-pills nav-stacked custom-nav">
                ...
                <li class="menu-list"><a href=""><i class="fa fa-laptop"></i> <span>帖子管理</span></a>
                    <ul class="sub-menu-list">
                        <li><a href="/admin.php">发表帖子</a></li>
                        <li><a href="/admin.php/Post/all">帖子列表</a></li>
            ...
            <div class="panel-body">
                <form id="xxx" class="form-horizontal adminex-form registerform" method="post" action="/manage/index.php?c=index&a=updateHospital">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea name="desc" nullmsg="请输入简介！" datatype="s6-500" errormsg="用户名至少6个字符,最多500个字符！" class="form-control"><?php echo ($hospitalInfo['desc']); ?></textarea>
                            <p class="help-block Validform_checktip"></p>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div id="icon-preview"><img src="/manage/Uploads/<?php echo ($hospitalInfo['icon']); ?>" /></div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <p class="help-block Validform_checktip">将展示在医院介绍页面</p>
                          <div id="poster-preview"><img src="/manage/Uploads/<?php echo ($hospitalInfo['poster']); ?>" /></div>
                        </div>
                    </div>
...
<script src="/Public/js/wysieditor.js"></script>
<script>
	$(function(){
		$('#editor').wysiwyg();
	});
